...
const SUPPORTED_NETWORKS = [Network.MAINNET, Network.KOVAN, Network.RINKEBY, Network.ROPSTEN, Network.GOERLI, Network.POLYGON];
...
export default function useBlocknative() {
  ...
  const supportsBlocknative = computed(() => SUPPORTED_NETWORKS.includes(appNetworkConfig.chainId));
