...
export default defineComponent({
  ...
  setup() {
    ...
    const depositTokenId =
      '0x293bbbef6087f681a8110f08bbdedadd13599fc3000200000000000000000007';
    const depositTokenAddress = '0x293bbbef6087f681a8110f08bbdedadd13599fc3';
    ...
    onMounted(async () => {
      ...
      const nearPrice =
        balPrices.value['0xC42C30aC6Cc15faC9bD938618BcaA1a1FaE8501d']['usd'];
