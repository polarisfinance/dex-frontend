...
<template>
  <div class="table-container overflow-x-auto p-[24px]" :square="upToLargeBreakpoint" :noBorder="upToLargeBreakpoint" noPad>
    <div class="grid-table min-w-[480px]">
      ...
      <div v-for="(action, index) in activityRows" :key="index" class="flex table-row w-full items-center">
        ...
        <div class="flex items-center justify-start">
          <div v-for="(tokenAmount, i) in action.tokenAmounts" :key="i">
            <div v-if="tokenAmount.amount !== '0'" class="token-card mr-[8px] flex items-center text-center">
