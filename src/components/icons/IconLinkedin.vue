<template>
  <svg id="linkedin" class="social-icon" width="32" height="32" xmlns="http://www.w3.org/2000/svg" aria-labelledby="linkedinTitle" role="img">
    <title id="linkedinTitle">Link to Balancer's LinkedIn profile</title>
    <g fill-rule="nonzero" fill="none">
      <path class="bg" d="M16 0C7.163 0 0 7.164 0 16s7.163 16 16 16c8.836 0 16-7.163 16-16 0-8.836-7.164-16-16-16z" />
      <path
        class="logo"
