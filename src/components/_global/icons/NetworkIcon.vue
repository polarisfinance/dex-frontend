...
const color = computed(() => (darkMode.value ? theme.colors.white : theme.colors.black));
</script>
...
<template>
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    />
    <path d="M1.6665 10H18.3332" :stroke="color" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
    <path
