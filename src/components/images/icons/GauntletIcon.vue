<template>
  <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
    <g fill="none" fill-rule="evenodd">
      ...
      <g fill-rule="nonzero">
        <path d="M11.608 12.19v-2.095H9.453V8h4.31v4.19h-2.155zm2.155-6.285H7.298v6.285H5.143V3.81h8.62v2.095z" fill="#87ABC5" />
        <path fill="#87ABC5" d="M13.763 13.029v1.257H7.298V12.19h4.31v-.942h2.155z" />
